...
// +kubebuilder:rbac:groups=candor.candor.dev,resources=findings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=candor.candor.dev,resources=findings/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=candor.candor.dev,resources=findings/finalizers,verbs=update
