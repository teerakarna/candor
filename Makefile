...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name candor-builder
	$(CONTAINER_TOOL) buildx use candor-builder
	...
	- $(CONTAINER_TOOL) buildx rm candor-builder
	rm Dockerfile.cross
