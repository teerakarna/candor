...
*/}}
{{- define "candor.resourceName" -}}
{{- $fullname := include "candor.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "candor.serviceAccountName" -}}
{{- if .Values.serviceAccount.enabled }}
{{- include "candor.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- else }}
